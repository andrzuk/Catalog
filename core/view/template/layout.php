...
echo '<script type="text/javascript" src="js/jquery.dynDateTime/jquery.dynDateTime.js"></script>';
echo '<script type="text/javascript" src="js/jquery.dynDateTime/lang/calendar-en.js"></script>';
...
echo "  ga('create', 'UA-16941734-17', 'active-cms.eu');";
...
echo 'js.src = "//connect.facebook.net/pl_PL/all.js#xfbml=1&appId=214650075346059";';
