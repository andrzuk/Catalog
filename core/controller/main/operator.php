...
class Operator
{
	...
	public function __construct($objects)
	{
		...
		$this->model_object = $objects['model_object'];
		$this->view_object = $objects['view_object'];
		$this->record_object = $objects['record_object'];
		$this->navi_object = $objects['navi_object'];
		$this->db_params = $objects['db_params'];
		$this->list_params = $objects['list_params'];
		$this->list_columns = $objects['list_columns'];
		
		$this->data_import = $objects['data_import'];
