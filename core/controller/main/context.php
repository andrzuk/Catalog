...
class Context
{
	...
	public function get_search()
	{
		...
		$output .= '<tr>';
		$output .= '<td width="60%">';
		$output .= '<input type="text" name="search_text" value="" class="FormInput" style="width: 90%;" />';
		$output .= '</td>';
		$output .= '<td width="40%">';
...
*/		
	...
	public function get_facebook()
	{
		...
		$output .= '<a href="http://harpo.com.pl" target="_blank"><img src="img/logo_harpo.png" style="border: 0px solid #fff;" alt="harpo" title="Logo Harpo" /></a>';
		*/
		$output .= '<a href="index.php?route=page&id=66"><img src="img/copyright.png" style="border: 0px solid #fff; vertical-align: middle; padding-right: 10px;" alt="nota prawna" title="Nota prawna" />Nota prawna</a>';
		
		$output .= '<div class="Separator"></div>';
		
		$output .= '<div class="fb-like" data-href="https://www.facebook.com/pages/Katalog-instrukcji/139354429595569" data-width="150" data-colorscheme="light" data-layout="button_count" data-action="like" data-show-faces="false" data-send="true"></div>';
