...
class PageController extends Controller
{
	...
	public function init($links, $path, $menu)
	{
		$this->links = $links;
		$this->path = $path;
		$this->menu = $menu;
	...
	{
		// pokazuje imię i nazwisko zalogowanego użytkownika:
		$output = $this->get_user();
		
		// pokazuje górne linki:
		$output .= $this->links;
	...
	public function get_path()
	{
		...
		$output .= '<span class="StatIcon"><a href="index.php?route=stats"><img src="img/16x16/layer_chart.png" class="TopLinkIcon" alt="Statystyka artykułów" title="Statystyka artykułów" /></a></span>';
